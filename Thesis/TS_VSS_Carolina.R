...
#Number.deaths.week.plot (SowsDeaths) ----
...
#Mortality in tillväxt pigs (PigletsDeaths) ----
...
##HoltWinters - doesn't have LCL, so I can't do it for services

##EWMA

plot(my.syndromic@observed[,1],type="lines")
lines(my.syndromic@baseline[,1],col="blue")
lines(my.syndromic@LCL[,1,2],col="green")

##Shewhart

lines(my.syndromic@LCL[,1,3],col="purple")

##CUSUM

lines(my.syndromic@LCL[,1,4],col="orange")
...
plot(my.syndromic@observed[,2],type="lines")
lines(my.syndromic@baseline[,2],col="blue")
lines(my.syndromic@UCL[,2,1],col="grey")

##EWMA

lines(my.syndromic@UCL[,2,2],col="green")

##Shewhart

lines(my.syndromic@UCL[,2,3],col="purple")

##CUSUM

lines(my.syndromic@UCL[,2,4],col="orange")
...
plot(my.syndromic@observed[,3],type="lines")
lines(my.syndromic@baseline[,3],col="blue")
lines(my.syndromic@UCL[,3,1],col="grey")

##EWMA

lines(my.syndromic@UCL[,3,2],col="green")

##Shewhart

lines(my.syndromic@UCL[,3,3],col="purple")

##CUSUM

lines(my.syndromic@UCL[,3,4],col="orange")
...
plot(my.syndromic@observed[,4],type="lines")
lines(my.syndromic@baseline[,4],col="blue")
lines(my.syndromic@UCL[,4,1],col="grey")

##EWMA

lines(my.syndromic@UCL[,4,2],col="green")

##Shewhart

lines(my.syndromic@UCL[,4,3],col="purple")

##CUSUM

lines(my.syndromic@UCL[,4,4],col="orange")
...
services.week.total.lag <- lag(services.week.total, n=4)

ReservicesRate <- (reservices.week.total/services.week.total.lag)*100
 
##ReservicesRate ----

TS.ReservicesRate.plot <- TS.lineplot (series = ReservicesRate,
                                                 indicator.label="Reservices Rate",
                                                 show.window = weeks.to.show,
                                                 index.dates = index.dates.week,
                                                 ylabel = 'Rate of sows (%)',
                                                 xlabel = 'Week',
...
ggplotly(TS.ReservicesRate.plot)
